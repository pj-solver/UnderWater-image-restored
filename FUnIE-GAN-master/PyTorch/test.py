...
parser.add_argument("--data_dir", type=str, default="C:/Users/JW.Z/Desktop/Our_Lab_image/resize/")  #data/test/B/
parser.add_argument("--sample_dir", type=str, default="C:/Users/JW.Z/Desktop/Our_Lab_image/compare/Funie_Gan/")#data/output2/
parser.add_argument("--model_name", type=str, default="funiegan") # or "funiegan,ugan"
...
for path in test_files:
    ...
    # save output
    img_sample = gen_img.data #torch.cat((inp_img.data, gen_img.data), -1)
